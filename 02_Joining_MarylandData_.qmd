---
title: "Joining and Combining Data"
...
```{r}
maryland_population_with_voters <- maryland_population %>% 
  left_join(county_voters_2020)
```
...
maryland_population_with_voters_and_demographics <- 
  ...
  left_join(maryland_demographics, by=c("COUNTY"="NAME"))
```
